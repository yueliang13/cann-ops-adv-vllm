...
template <typename T> class MoeFinalizeRoutingFpDbAllBias {
public:
...
template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingFpDbAllBias<T>::AlignmentProcess(int64_t param)
{
    return (param + onceAlgnNum_ - 1) / onceAlgnNum_ * onceAlgnNum_;
}

template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingFpDbAllBias<T>::PadProcessT(int64_t param)
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingFpDbAllBias<T>::CalcPaddingPara()
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingFpDbAllBias<T>::PrepareData()
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingFpDbAllBias<T>::Process()
{
