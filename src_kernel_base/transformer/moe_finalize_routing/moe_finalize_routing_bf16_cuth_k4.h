...
template <typename T> class MoeFinalizeRoutingBf16CuthK4 {
public:
...
template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingBf16CuthK4<T>::AlignmentProcess(int64_t param)
{
    return (param + onceAlgnNum_ - 1) / onceAlgnNum_ * onceAlgnNum_;
}

template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingBf16CuthK4<T>::PadProcessT(int64_t param)
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingBf16CuthK4<T>::CkechColAlignment()
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingBf16CuthK4<T>::Process()
{
