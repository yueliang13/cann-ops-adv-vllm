...
template <typename T> class MoeFinalizeRoutingBF16 {
public:
...
template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingBF16<T>::AlignmentProcess(int64_t param)
{
    return (param + onceAlgnNum_ - 1) / onceAlgnNum_ * onceAlgnNum_;
}

template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingBF16<T>::PadProcess(int64_t param)
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingBF16<T>::CkechColAlignment()
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingBF16<T>::CopyIn(int64_t nLoopIdx, int64_t curRepeatTimes)
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingBF16<T>::Process()
{
