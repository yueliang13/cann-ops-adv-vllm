...
template <typename T> class MoeFinalizeRoutingFpCuthK2 {
public:
...
template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingFpCuthK2<T>::AlignmentProcess(int64_t param)
{
    return (param + onceAlgnNum_ - 1) / onceAlgnNum_ * onceAlgnNum_;
}

template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingFpCuthK2<T>::PadProcessT(int64_t param)
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingFpCuthK2<T>::CkechColAlignment()
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingFpCuthK2<T>::Process()
{
