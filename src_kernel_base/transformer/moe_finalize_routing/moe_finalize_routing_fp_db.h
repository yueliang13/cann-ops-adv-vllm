...
template <typename T> class MoeFinalizeRoutingFpDb {
public:
...
template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingFpDb<T>::AlignmentProcess(int64_t param)
{
    return (param + onceAlgnNum_ - 1) / onceAlgnNum_ * onceAlgnNum_;
}

template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingFpDb<T>::PadProcessT(int64_t param)
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingFpDb<T>::CopyIn(int64_t nLoopIdx, int64_t curRepeatTimes)
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingFpDb<T>::Process()
{
