...
template <typename T> class MoeFinalizeRoutingFpCuthK4 {
public:
...
template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingFpCuthK4<T>::AlignmentProcess(int64_t param)
{
    return (param + onceAlgnNum_ - 1) / onceAlgnNum_ * onceAlgnNum_;
}

template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingFpCuthK4<T>::PadProcessT(int64_t param)
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingFpCuthK4<T>::CkechColAlignment()
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingFpCuthK4<T>::Process()
{
