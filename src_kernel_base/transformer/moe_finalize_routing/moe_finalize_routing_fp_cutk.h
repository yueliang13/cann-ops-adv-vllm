...
template <typename T> class MoeFinalizeRoutingFpCutK {
public:
...
template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingFpCutK<T>::AlignmentProcess(int64_t param)
{
    return (param + onceAlgnNum_ - 1) / onceAlgnNum_ * onceAlgnNum_;
}

template <typename T> __aicore__ inline int64_t MoeFinalizeRoutingFpCutK<T>::PadProcessT(int64_t param)
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingFpCutK<T>::CkechColAlignment()
{
...
template <typename T> __aicore__ inline void MoeFinalizeRoutingFpCutK<T>::Process()
{
