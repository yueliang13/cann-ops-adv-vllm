...
namespace optiling {
ASCENDC_EXTERN_C ge::graphStatus TilingMoeGatingTopKSoftmax(gert::TilingContext* context) {
  // 初始化算子Tiling类
  return TilingRegistry::GetInstance().DoTilingImpl(context);
}

ASCENDC_EXTERN_C ge::graphStatus TilingPrepare4MoeGatingTopKSoftmax(gert::TilingParseContext* context) {
