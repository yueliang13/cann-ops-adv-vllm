...
template <typename T> class MoeV2FullLoad : public MoeV2SortBase {
public:
...
template <typename T> __aicore__ inline void MoeV2FullLoad<T>::CopyIn()
{
...
template <typename T> __aicore__ inline void MoeV2FullLoad<T>::SortCompute()
{
...
template <typename T> __aicore__ inline void MoeV2FullLoad<T>::CopyOutIdx()
{
...
template <typename T> __aicore__ inline void MoeV2FullLoad<T>::ComputeExpertTokenCountOrCumsum()
{
...
template <typename T> __aicore__ inline void MoeV2FullLoad<T>::CopyOutX()
{
...
template <typename T> __aicore__ inline void MoeV2FullLoad<T>::CopyOutEmpty()
{
                                              ...
                                              const MoeInitRoutingV2TilingData *tilingData, TPipe *tPipe)
{
    ...
    if (needCoreNum_ == 0){this->sortNeedCoreNum_ = tilingData->vbsComputeParamsOp.needCoreNum;}
...
template <typename T> __aicore__ inline void MoeV2FullLoad<T>::Process()
{
