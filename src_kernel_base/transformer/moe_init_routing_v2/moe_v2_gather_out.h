...
template <typename T> class MoeV2GatherOut {
public:
...
template <typename T> __aicore__ inline void MoeV2GatherOut<T>::CopyInIndices(int64_t progress)
{
...
template <typename T> __aicore__ inline void MoeV2GatherOut<T>::CopyOut(int64_t progress)
{
...
template <typename T> __aicore__ inline void MoeV2GatherOut<T>::Process()
{
