 ...
 */
__attribute__((visibility("default"))) aclnnStatus aclnnWeightQuantMatmulAllReduceGetWorkspaceSize(
 ...
 * @return aclnnStatus: 返回状态码
 */
__attribute__((visibility("default"))) aclnnStatus aclnnWeightQuantMatmulAllReduce(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor,
