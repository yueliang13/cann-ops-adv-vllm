 ...
 */
__attribute__((visibility("default"))) aclnnStatus aclnnInplaceMatmulAllReduceAddRmsNormGetWorkspaceSize(
 ...
 * @return aclnnStatus: 返回状态码
 */
__attribute__((visibility("default"))) aclnnStatus aclnnInplaceMatmulAllReduceAddRmsNorm(void *workspace, uint64_t workspaceSize,
