...
/*!
 * \file moe_token_permute_grad_case.h
...
namespace ops::adv::tests::MoeTokenPermuteGrad {
class MoeTokenPermuteGradCase : public ops::adv::tests::utils::Case {
...
public:
    ...
    public:
        ...
        Param(int64_t pN, int64_t pH, int64_t pK, bool pPaddedMode, ge::DataType permutedTokensDtypeIn,
              ge::DataType sortedIndicesDtypeIn);
    };
    class DoTilingParam {
    public:
    ...
    gert::OpImplRegisterV2::TilingKernelFunc moeTokenPermuteGradTilingFunc = nullptr;
    MoeTokenPermuteGradCase();
    MoeTokenPermuteGradCase(const char *name, bool enable, const char *dbgInfo, OpInfo incre, Param param);
    bool Run() override;
