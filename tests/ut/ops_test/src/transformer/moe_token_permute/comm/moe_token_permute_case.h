...
namespace ops::adv::tests::MoeTokenPermute {
class MoeTokenPermuteCase : public ops::adv::tests::utils::Case {
...
public:
    ...
    public:
        ...
        Param();
        Param(int64_t pN, int64_t pH, int64_t pK, int64_t pActiveNum, int64_t pC, int64_t pE,
    ...
    gert::OpImplRegisterV2::TilingKernelFunc moeTokenPermuteTilingFunc = nullptr;
    MoeTokenPermuteCase();
    MoeTokenPermuteCase(const char *name, bool enable, const char *dbgInfo, OpInfo incre, Param param);
    bool Run() override;
