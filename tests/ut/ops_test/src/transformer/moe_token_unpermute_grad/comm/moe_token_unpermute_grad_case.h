...
/*!
 * \file moe_token_unpermute_grad_case.h
...
namespace ops::adv::tests::MoeTokenUnpermuteGrad {
class MoeTokenUnpermuteGradCase : public ops::adv::tests::utils::Case {
...
public:
    ...
    public:
        ...
        ge::DataType unpermutedTokensGradDtype = ge::DataType::DT_FLOAT;
        ge::DataType sortedIndicesDtype = ge::DataType::DT_INT32;
        ge::DataType probsDtype = ge::DataType::DT_FLOAT;

        Param();
        Param(int64_t pN, int64_t pH, int64_t pK, bool pPaddedMode, 
    ...
    Tensor unpermutedTokensGrad;
    Tensor sortedIndices;
    Tensor probs;
    Tensor permutedTokensGrad;
    Tensor probsGrad;
    gert::OpImplRegisterV2::TilingKernelFunc moeTokenUnpermuteGradTilingFunc = nullptr;
    MoeTokenUnpermuteGradCase();
    MoeTokenUnpermuteGradCase(const char *name, bool enable, const char *dbgInfo, OpInfo incre, Param param);
    bool Run() override;
