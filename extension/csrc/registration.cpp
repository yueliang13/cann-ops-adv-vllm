...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
    ...
    m.def("sparse_paged_attention", &sparse_paged_attention_impl_npu, "Sparse Paged Attention implementation");
