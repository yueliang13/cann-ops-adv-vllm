...
template <typename IFAT> class SparsePagedFusionAttentionAttenAllVecNew {
public:
    __aicore__ inline SparsePagedFusionAttentionAttenAllVecNew(){};
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                ...
                                const SparsePagedFusionAttentionTilingData *__restrict tiling, TPipe *tPipe);
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::InitTilingData()
{
    ...
    blockSplitBn2Range = tilingData->sparsePagedFusionAttentionSingleCoreParams.blockSplitBn2Range;
    tailBlockSplitBn2Range = tilingData->sparsePagedFusionAttentionSingleCoreParams.tailSplitedBatchRange;
    ...
    coreStartIdx = tilingData->sparsePagedFusionAttentionCoreParams.coreSidxEnd;
    // out quant
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::InitBuffers()
{
    // 0-32K
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::CalculateCopyKvSplitS()
{
    // 1、非量化场景：KV_T=Q_T
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::UpdateCopyKvParam()
{
    // copy key param
...
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::InitActualSeqLen(__gm__ uint8_t *actualSeqLengths)
{
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::InitAllZeroOutput(uint32_t bIdx)
{
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::GetActualSeqLen()
{
    if (actualLenDims == 0) {
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::GetBN2id(const uint32_t bn2Idx)
{
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::UpdateInnerLoopCond()
{
...
template <typename IFAT>
__aicore__ inline uint64_t SparsePagedFusionAttentionAttenAllVecNew<IFAT>::SeqLenFromTensorList(uint32_t bIndex)
{
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::CalculateSUnitSize()
{
    if constexpr (LAYOUT_T == LAYOUT::BSH || LAYOUT_T == LAYOUT::BSND) {
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::CalculatekvPaddingSPadDataNum(int64_t &startPosition)
{
...
template <typename IFAT> __aicore__ inline bool SparsePagedFusionAttentionAttenAllVecNew<IFAT>::ComputeKVPaddingBeginOffset()
{
    if (kvPaddingFlag != 1) {
        return true;
    }
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::Init(
...
SparsePagedFusionAttentionAttenAllVecNew<IFAT>::InitQuant(__gm__ uint8_t *deqScale1, __gm__ uint8_t *quantScale1,
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::InitCalcParams()
{
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::InitCalcParamsEach()
{
    bn2LoopTimes = coreStartIdx[tmpBlockIdx + 1] - coreStartIdx[tmpBlockIdx];
    beforeBlockSplitBn2Nums = coreStartIdx[tmpBlockIdx];
}

template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::CalcBN2Offset()
{
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::CalcBN2Params()
{
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::CalcSInnerOffsetAndParams(const uint32_t sInnerLoopIdx)
{
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::UpdateIsUseDataCopyPad()
{
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::InitDataCopyExtParams(DataCopyExtParams &intriParams,
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::InitDataCopyParams(DataCopyParams &intriParams,
                                                                                   uint32_t rowCnt)
{
    uint32_t typeElementSize = ONE_BLK_SIZE / sizeof(KV_T);
    intriParams.blockCount = rowCnt; // 需要copy的数据块个数，repeat次数
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::CopyKV(LocalTensor<KV_T> dstLocal,
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::CopyZero(LocalTensor<KV_T> dstLocal, uint32_t rowCnt)
{
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::AttenMaskCopyIn(uint64_t offset, uint32_t dealRowCount,
                                                                                uint32_t actualColumnCount)
{
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::QueryPreProcess()
{
...
template <typename IFAT>
__aicore__ inline void
SparsePagedFusionAttentionAttenAllVecNew<IFAT>::ComputeScaleValue(LocalTensor<T> &lseMaxUb, LocalTensor<T> &lseSumUb,
                                                           LocalTensor<T> &lseExpUb, LocalTensor<T> &lseLocal)
{
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::CombineSplitKVRes()
{
    if (curActualSeqLen == 0) {
        // 待补充，置0操作
    } else {
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::FlashDecodeCompute()
{
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::SoftmaxLseCopyOut(LocalTensor<T> &softmaxSumUb,
                                                                                  LocalTensor<T> &softmaxMaxUb)
{
#if (__CCE_AICORE__ > 200)
    // 非GQA走全V,gSize为1
...
template <typename IFAT>
__aicore__ inline void
SparsePagedFusionAttentionAttenAllVecNew<IFAT>::ComputeLogSumExpAndCopyToGm(LocalTensor<T> &softmaxSumUb,
                                                                     LocalTensor<T> &softmaxMaxUb)
{
    // 非GQA走全V,gSize为1
    LocalTensor<T> lseUb = outputQue1.AllocTensor<T>();
...
template <typename IFAT>
__aicore__ inline void
SparsePagedFusionAttentionAttenAllVecNew<IFAT>::ComputeMm1ByVmla(LocalTensor<T> &mmResUb, LocalTensor<Q_T> &aUb,
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::ComputeSingleMm1(uint32_t startRow,
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::Bmm1Compute()
{
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::ComputeMm2ByVmla(
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::AccumulateByRow(LocalTensor<T> &srcUb,
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::CopyValueToUb(uint32_t startRow, uint32_t dealRowCount)
{
    uint64_t step;
    // if constexpr (!PAGE_ATTENTION) {
    //     if constexpr (LAYOUT_T == LAYOUT::BNSD) {
...
template <typename IFAT>
__aicore__ inline void
SparsePagedFusionAttentionAttenAllVecNew<IFAT>::ComputeSingleMm2(LocalTensor<T> vmlaResUb, uint32_t startRow,
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::GetConfusionTransposeTiling(
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::Bmm2Compute()
{
    // 单次处理行数
    LocalTensor<T> vmlaResUb = tmpBuff1.Get<T>();
    uint32_t elementSize = vmlaResUb.GetSize();
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::ElewiseCompute(LocalTensor<T> &mmResUb, TBuf<> &tmpBuf,
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::SoftmaxFlashV2Compute(
...
template <typename IFAT>
__aicore__ inline void
SparsePagedFusionAttentionAttenAllVecNew<IFAT>::Bmm2FDDataCopyOut(LocalTensor<T> &attenOutUb, uint32_t startRow,
...
template <typename IFAT>
__aicore__ inline void
SparsePagedFusionAttentionAttenAllVecNew<IFAT>::Bmm2DataCopyOut(LocalTensor<OUT_T> &attenOutUb, uint32_t startRow,
                                                         uint32_t dealRowCount, uint32_t columnCount,
                                                         uint32_t actualColumnCount)
{
...
template <typename IFAT>
__aicore__ inline void
SparsePagedFusionAttentionAttenAllVecNew<IFAT>::Bmm2CastAndCopyOut(LocalTensor<T> &bmm2ResUb, uint32_t startRow,
                                                            uint32_t dealRowCount, uint32_t columnCount,
                                                            uint32_t actualColumnCount)
{
    if constexpr (FLASH_DECODE) {
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::PseShiftCopyIn(uint32_t startRow, uint32_t rowCount,
                                                                               uint32_t actualColumnCount)
{
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::ColumnSum(LocalTensor<T> srcUb, uint32_t dealRowCount,
                                                                          uint32_t columnCount)
{
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::ProcessVec1(const uint32_t sInnerLoopIdx)
{
    pipe_barrier(PIPE_V);
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::ProcessVec2(const uint32_t sInnerLoopIdx)
{
    // 最后一次输出计算结果
...
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::SampleAndPrintUbData(
...
template <typename IFAT>
__aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::SInnerLoopFunc(const uint32_t sInnerLoopIdx)
{
    // mm1
    Bmm1Compute();
    // 采样 Bmm1 的结果 (Q @ K.T)
...
template <typename IFAT> __aicore__ inline void SparsePagedFusionAttentionAttenAllVecNew<IFAT>::Process()
{
