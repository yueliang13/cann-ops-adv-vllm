...
/*!
 * \file sparse_paged_fusion_attention_tiling.cc
 * \brief
 */
...
ge::graphStatus SparseFusionIFATiling::GetNpuInfo()
{
...
ge::graphStatus SparseFusionIFATiling::PreProcess()
{
...
ge::graphStatus SparseFusionIFATiling::SetL2CacheFlag()
{
    ...
    switch (kDType) {
        ...
        default:
            OPS_LOG_E(context_->opName, "Data type %s is not currently supported.",
                      SparseFusionDataTypeToSerialString(kDType).c_str());
            return ge::GRAPH_FAILED;
    }
...
ge::graphStatus SparseFusionIFATiling::QKVPreProcess() {
...
ge::graphStatus SparseFusionIFATiling::InputAttrsPreProcess() {
...
ge::graphStatus SparseFusionIFATiling::SetQuantFlag() {
...
ge::graphStatus SparseFusionIFATiling::ProcessBaseInputs()
{
...
void SparseFusionIFATiling::SetupPerfMode()
{
    // 310P
...
void SparseFusionIFATiling::UpdatePerfMode()
{
    if (EnableC1V1()) {
...
ge::graphStatus SparseFusionIFATiling::KvShapePostProcess()
{
    if (pageAttentionFlag_) {
...
ge::graphStatus SparseFusionIFATiling::ZeroTensorProcess()
{
    if (sMax_ == 0) {
        /*
...
ge::graphStatus SparseFusionIFATiling::InitInOutMode()
{
...
ge::graphStatus SparseFusionIFATiling::ProcessOptionalTensors()
{
...
ge::graphStatus SparseFusionIFATiling::ProcessActualSeqLen()
{
...
ge::graphStatus SparseFusionIFATiling::ProcessQuant1()
{
...
ge::graphStatus SparseFusionIFATiling::ProcessQuant2Dtype()
{
...
ge::graphStatus SparseFusionIFATiling::ProcessQuant2()
{
...
ge::graphStatus SparseFusionIFATiling::ProcessDequant1()
{
...
ge::graphStatus SparseFusionIFATiling::ProcessDequant2()
{
...
ge::graphStatus SparseFusionIFATiling::CheckKVAntiQuantParamsShapeInPagedAttention(const gert::Shape &inputParaShape) {
...
ge::graphStatus SparseFusionIFATiling::CheckKVAntiQuantParamsInPagedAttention() {
...
ge::graphStatus SparseFusionIFATiling::CheckKVAntiQuantPerToken(const gert::Shape &inputParaShape)
{
...
ge::graphStatus SparseFusionIFATiling::CheckKVAntiQuantParaShapeLegal(const gert::Shape &inputParaShape)
{
...
ge::graphStatus SparseFusionIFATiling::CheckAntiQuantParamKeyType(const gert::Tensor *antiquantOffsetTensor,
...
ge::graphStatus SparseFusionIFATiling::CheckAntiQuantParamValueType(const gert::Tensor *antiquantOffsetTensor,
                                                        const gert::CompileTimeTensorDesc *antiquantScaleDesc,
                                                        const gert::CompileTimeTensorDesc *antiquantOffsetDesc)
{
    ge::DataType antiquantScaleType = antiquantScaleDesc->GetDataType();
...
ge::graphStatus SparseFusionIFATiling::ProcessAntiQuant()
{
...
ge::graphStatus SparseFusionIFATiling::ProcessBlockTable()
{
    if (!pageAttentionFlag_) {
        return ge::GRAPH_SUCCESS;
    }
...
ge::graphStatus SparseFusionIFATiling::ProcessKVPaddingSize()
{
...
ge::graphStatus SparseFusionIFATiling::ProcessSharedPrefix()
{
...
uint32_t SparseFusionIFATiling::GetAntiquantSeqLength()
{
    if (antiquantParamsInPagedAttentionFlag_) {
        return seqSize_;
    }
...
ge::graphStatus SparseFusionIFATiling::ProcessSharedPrefixLen()
{
...
ge::graphStatus SparseFusionIFATiling::Split()
{
    if (IsFlashDecode()) {
        splitKVFlag_ = true;
        kvSplit_++;
...
ge::graphStatus SparseFusionIFATiling::SplitBN()
{
...
std::vector<int64_t> SparseFusionIFATiling::InitSparseValidArray(const int64_t *actualLens)
{
...
bool SparseFusionIFATiling::BalanceLoad(const std::vector<int64_t> &sparseValidArray, int64_t totalSize, int64_t validAivNum,
...
void SparseFusionIFATiling::InitLoadValue(const std::vector<int64_t> &sparseValidArray, int64_t totalSize, int64_t validAivNum,
...
void SparseFusionIFATiling::SetSparseStartIdx(const std::vector<int64_t> &sparseValidArray, int64_t totalSize, int64_t validAivNum,
...
ge::graphStatus SparseFusionIFATiling::SplitBN_V0()
{
    uint32_t bn = batchSize_ * numKvHeads_;
...
ge::graphStatus SparseFusionIFATiling::SplitBNS()
{
    formerCoreNum_ = 0;
...
ge::graphStatus SparseFusionIFATiling::CalcInnerSize(uint32_t seqSize)
{
    /**
...
bool SparseFusionIFATiling::CalcUbBmm()
{
...
bool SparseFusionIFATiling::CalcUbSoftMax()
{
...
bool SparseFusionIFATiling::CalcUbAttenMask()
{
    if (!attenMaskFlag_) {
...
ge::graphStatus SparseFusionIFATiling::CalcWorkSpace()
{
...
ge::graphStatus SparseFusionIFATiling::FillTiling()
{
...
void SparseFusionIFATiling::FillTilingBaseParams()
{
...
// for flash decode
void SparseFusionIFATiling::FillTilingSplitKV()
{
...
{
    uint32_t *coreStartIdx = tilingData_->sparsePagedFusionAttentionCoreParams.get_coreSidxEnd();
    memcpy_s(coreStartIdx, MAX_CORE_NUM * sizeof(uint32_t), startIdxEachCore_, MAX_CORE_NUM * sizeof(uint32_t));
}

void SparseFusionIFATiling::FillTilingSingleCoreParams()
{
    tilingData_->sparsePagedFusionAttentionSingleCoreParams.set_sInnerLoopTimes(sInnerLoopTimes_);
    tilingData_->sparsePagedFusionAttentionSingleCoreParams.set_singleProcessSInnerSize(sInnerSize_);
    tilingData_->sparsePagedFusionAttentionSingleCoreParams.set_singleProcessSInnerSizeTail(sInnerSizeTail_);
    tilingData_->sparsePagedFusionAttentionSingleCoreParams.set_usedCoreNum(usedCoreNum_);
    tilingData_->sparsePagedFusionAttentionSingleCoreParams.set_formerCoreNum(formerCoreNum_);
    tilingData_->sparsePagedFusionAttentionSingleCoreParams.set_blockSplitBn2Range(blockSplitBn2Range_);
    tilingData_->sparsePagedFusionAttentionSingleCoreParams.set_tailSplitedBatchRange(tailSplitedBatchRange_);
}

void SparseFusionIFATiling::FillTilingSingleCoreTensorSize()
{
    tilingData_->sparsePagedFusionAttentionSingleCoreTensorSize.set_mmResUbSize(mmResUbSize_);
    tilingData_->sparsePagedFusionAttentionSingleCoreTensorSize.set_bmm2ResUbSize(bmm2ResUbSize_);
}

void SparseFusionIFATiling::FillTilingSoftmax()
{
...
// for zero output
void SparseFusionIFATiling::FillTilingOutputParams()
{
...
void SparseFusionIFATiling::AdjustPABmm1Tiling(uint32_t &bmm1BaseN)
{
...
void SparseFusionIFATiling::AdjustPABmm2Tiling() const
{
...
bool SparseFusionIFATiling::GetBmm1Tiling(const matmul_tiling::DataType &qType, const matmul_tiling::DataType &kvType,
                              const uint32_t M)
{
    auto ascendcPlatform = platform_ascendc::PlatformAscendC(context_->platformInfo);
...
bool SparseFusionIFATiling::GetBmm2Tiling(const matmul_tiling::DataType &qType, const matmul_tiling::DataType &kvType,
                              const uint32_t M)
{
    auto ascendcPlatform = platform_ascendc::PlatformAscendC(context_->platformInfo);
...
bool SparseFusionIFATiling::FillTilingBmm()
{
...
bool SparseFusionIFATiling::GetMatmulType(ge::DataType getype, matmul_tiling::DataType *mmType)
{
    static struct {
        ge::DataType a;
...
ge::graphStatus SparseFusionIFATiling::GenTilingKey()
{
...
ge::graphStatus SparseFusionIFATiling::CalcBlockDim()
{
    auto ascendcPlatform = platform_ascendc::PlatformAscendC(context_->platformInfo);
    auto aicNum = aicNum_;
    auto aivNum = aivNum_;
...
ge::graphStatus SparseFusionIFATiling::SharedPrefixTiling()
{
    // 重新配置长度
...
ge::graphStatus SparseFusionIFATiling::FillSysPrefixTiling()
{
...
ge::graphStatus SparseFusionIFATiling::CalcSysPrefixWorkSpace()
{
...
ge::graphStatus SparseFusionIFATiling::CalcSysPrefixBlockDim()
{
...
ge::graphStatus SparseFusionIFATiling::SplitForLseCombine()
{
...
ge::graphStatus SparseFusionIFATiling::ConvertContext(gert::TilingContext &context, SparsePagedFusionAttentionContext &ifaContext)
{
    if (context.GetNodeName() == nullptr) {
        OPS_LOG_E("SparsePagedFusionAttention", "opName got from TilingContext is nullptr");
        return ge::GRAPH_FAILED;
    }
...
ge::graphStatus SparseFusionIFATiling::RunBigKernelTiling(SparsePagedFusionAttentionContext &context,
                                              SparsePagedFusionAttentionTilingDataV2 &tilingData, bool isWorkspace)
{
...
ge::graphStatus SparseFusionIFATiling::SparsePagedFusionAttentionSetTilingData(gert::TilingContext &context,
...
std::string SparseFusionDataTypeToSerialString(ge::DataType type)
{
    ...
    if (it != DATATYPE_TO_STRING_MAP.end()) {
        ...
        OPS_LOG_E("SparsePagedFusionAttention", "datatype %d not support", type);
        return "UNDEFINED";
    }
}
...
{
    SparseFusionIFATiling ifaTilingNew;
    if (ifaTilingNew.RunBigKernelTiling(ifaContext, ifaTilingData) == ge::SUCCESS) {
        ...
        ifaTilingNew.SparsePagedFusionAttentionSetTilingData(*context, ifaTilingData);
        return ge::GRAPH_SUCCESS;
    }
...
{
    OPS_ERR_IF(context == nullptr, OPS_REPORT_VECTOR_INNER_ERR("SparsePagedFusionAttention", "Context is nullptr."),
               return ge::GRAPH_FAILED);
    SparsePagedFusionAttentionTilingDataV2 tilingData;
    SparsePagedFusionAttentionContext ifaContext{.opName = nullptr,
        ...
        .tilingKey = 0,
        .blockDim = 0};
if (SparseFusionIFATiling::ConvertContext(*context, ifaContext) != ge::GRAPH_SUCCESS) {
        OPS_LOG_E(context->GetNodeName(), "Error occurred while converting tilingContext to ifa context");
        return ge::GRAPH_FAILED;
    }
    return TilingSparsePagedFusionAttentionAdapter(context, ifaContext, tilingData);
}
} // namespace optiling
