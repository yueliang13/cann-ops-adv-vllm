 ...
 */
__attribute__((visibility("default"))) aclnnStatus aclnnComputeCentGetWorkspaceSize(
 ...
 * @return aclnnStatus: 返回状态码
 */
__attribute__((visibility("default"))) aclnnStatus aclnnComputeCent(void *workspace, uint64_t workspaceSize,
