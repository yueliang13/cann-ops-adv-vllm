...
int main() {
  ...
  std::vector<int64_t> keyShape = {32, 1, 128, 128}; // BNSD
  std::vector<int64_t> valueShape = {32, 1, 128, 128}; // BNSD
  std::vector<int64_t> attenShape = {1023, 2048};
  std::vector<int64_t> outShape = {2, 4, 1023, 128}; // BNSD
  std::vector<int64_t> blockShape = {2, 16};
  void *queryDeviceAddr = nullptr;
  void *keyDeviceAddr = nullptr;
  void *valueDeviceAddr = nullptr;
  void *attenDeviceAddr = nullptr;
  void *outDeviceAddr = nullptr;
  void *blockDeviceAddr = nullptr;
  ...
  int64_t blockShapeSize = GetShapeSize(blockShape);
  ...
  std::vector<float> blockHostData(blockShapeSize, 1);
  ...
  ret = CreateAclTensor(blockHostData, blockShape, &blockDeviceAddr, aclDataType::ACL_INT32, &blockTensor);
  CHECK_RET(ret == ACL_SUCCESS, return ret);
  
  std::vector<int64_t> actualSeqlenVector = {2047, 2047};
  ...
  ret = aclnnFusedInferAttentionScoreV2GetWorkspaceSize(queryTensor, tensorKeyList, tensorValueList,  nullptr, attenTensor, nullptr, actualSeqLengths, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, blockTensor, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr,
